...
hero_image: './count-of-monte-cristo-book-cover.jpeg'
hero_image-alt: 'Book Cover to the Conte of Monte Cristo Book'
hero_image_figcaption: 'Book Cover to the Conte of Monte Cristo Book'
hero_image_class: ''
canonical: ''
---

<small>
  Note: Taken from [The Count of Monte
  Cristo](http://www.gutenberg.org/files/1184/1184-h/1184-h.htm). Afterall, the
  Gatsby Theme Naked was made in Paris with 🧡.
</small>
...
![First Image: We meet our hero, Edmond Dantès](edmond-dantes.jpeg)
...
## ![Dantès on Board](dantes-on-board.jpeg)
