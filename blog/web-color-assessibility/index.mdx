...
<figure>
  ![this is the mailchimp signup box before making it
  accessible](./mailchimp-before.png)
  <figcaption>
...
<figure>
 ![this is the code editor block before making it accessible](./code-editor-block.png)
